...
///
/// Mirrored by `script/license-tool/Sources/license-tool/LicenseCodec.swift` — keep
/// both in sync. `LicenseValidatorTests.testGoldenFixture` pins the wire format.
nonisolated enum LicenseCodec {
