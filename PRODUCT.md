...
- **Developer context in the menu bar.** Subscription windows for Claude Code, Codex, and Gemini sit beside proxy and exit-node context; Finder actions open terminals, create files from type-aware and user templates (including Word / Excel / PowerPoint), and route selected files without leaving Finder.
