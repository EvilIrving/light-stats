...
final class VisualThemeCaptureTests: XCTestCase {
    func testCaptureThemesForVisualReview() throws {
        ...
        try capture(.film, filename: "golden-hour-panel.png")
        try capture(.film, initialTab: 1, filename: "golden-hour-cleanup-panel.png")
        try capture(.bar, filename: "amber-panel.png")
        try capture(.bar, initialTab: 1, filename: "amber-cleanup-panel.png")
